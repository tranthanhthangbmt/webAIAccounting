...
- 📥 **<a href="Datasets/Sales_DirtyData.xlsx" download target="_blank"><strong>Sales_DirtyData.xlsx</strong></a>**: Bộ dữ liệu giả định chứa nhiều lỗi (Dirty Data) để thực hành làm sạch dữ liệu.
- 📥 **<a href="Datasets/Sihryas_Beauty_Sales.csv" download target="_blank"><strong>Sihryas_Beauty_Sales.csv</strong></a>**: Dữ liệu bán hàng chi tiết của Cửa hàng Làm đẹp Sihrya's để thực hành phân tích sinh lời và PivotTable.
