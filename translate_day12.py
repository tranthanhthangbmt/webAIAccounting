...
KEYWORDS = [
    "ChatGPT", "Generative AI", "Prompt", "Prompts", "Prompting", "Plugins",
    "Natural Language Processing", "NLP", "GPT", "Artificial Intelligence", "AI",
    "Machine Learning", "ML", "Deep Learning", "DL", "Web-Enhanced"
]
...
if __name__ == "__main__":
    chunks = glob.glob(r"d:\DongAUniversity\TÀI LIỆU DẠY HỌC_2024-2025\Môn TTNT cho kế toán_2026\webAIAccounting\chunk12A_*.txt")
