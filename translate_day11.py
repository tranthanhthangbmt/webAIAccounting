...
KEYWORDS = [
    "Relational Databases", "Relational Database", "Power BI", "Tableau",
    "Excel", "Data Visualization", "Data Analytics", "Analytics",
    "Database", "Primary Key", "Foreign Key", "SQL"
]
...
def pre_process(text):
    ...
    # Also "Exhibit X:" is common in accounting books
...
if __name__ == "__main__":
    chunks = glob.glob(r"d:\DongAUniversity\TÀI LIỆU DẠY HỌC_2024-2025\Môn TTNT cho kế toán_2026\webAIAccounting\chunk11A_*.txt")
