...
# Gather chunks
en_chunks = []
en_chunks += sorted(glob.glob(r"chunk14A_*.txt"))
en_chunks += sorted(glob.glob(r"chunk14B_*.txt"))
...
<head>
    ...
    <title>Buổi 14 - Phân tích Dữ liệu Chuyên sâu (Khám phá & Kể chuyện dữ liệu)</title>
...
<body>
    ...
    <h1>Buổi 14: Phân tích dữ liệu chuyên sâu (Data Exploration & Communicating Results)</h1>
...
with codecs.open("Buoi_14.html", "w", "utf-8") as f:
    f.write(html_content)

print("Generated Buoi_14.html successfully.")
