...
en_chunks = [
    "chunkA1_1.txt", "chunkA1_2.txt", "chunkA2.txt", "chunkA3.txt", "chunkA4.txt",
    "chunkB1.txt", "chunkB2.txt", "chunkB3.txt", "chunkB4.txt", "chunkB5.txt"
]

vi_chunks = [
    "chunkA1_1_vi.txt", "chunkA1_2_vi.txt", "chunkA2_vi.txt", "chunkA3_vi.txt", "chunkA4_vi.txt",
    "chunkB1_vi.txt", "chunkB2_vi.txt", "chunkB3_vi.txt", "chunkB4_vi.txt", "chunkB5_vi.txt"
]
...
<head>
    ...
    <title>Buổi 2 - AI and Blockchain in Finance & Data Science</title>
...
<body>
    ...
    <h1>Buổi 2: AI and Blockchain in Finance & Data Science</h1>
...
with codecs.open("Buoi_02.html", "w", "utf-8") as f:
    f.write(html_content)

print("Generated Buoi_02.html successfully.")
