...
def main():
    ...
    en_content = ""
    for i in range(1, 5):
        en_content += read_file(f"chunk5A_{i}.txt") + "\n\n"
    for i in range(1, 4):
        en_content += read_file(f"chunk5B_{i}.txt") + "\n\n"

    # Read Vietnamese chunks
    vi_content = ""
    for i in range(1, 5):
        vi_content += read_file(f"chunk5A_{i}_vi.txt") + "\n\n"
    for i in range(1, 4):
        vi_content += read_file(f"chunk5B_{i}_vi.txt") + "\n\n"
...
<head>
    ...
    <title>Tài liệu Buổi 5 - AI Accounting</title>
...
<div class="container">
    <h1 style="text-align: center; color: #333;">Tài liệu Buổi 5: AI trong Quản lý & Ra Quyết Định</h1>
...
<script>
    ...
    with open('Buoi_05.html', 'w', encoding='utf-8') as f:
        f.write(html_content)
    print("Successfully created Buoi_05.html")
