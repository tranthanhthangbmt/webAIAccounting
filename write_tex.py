...
\begin{frame}{Mục tiêu Bài học (Lesson Objectives - LO)}
    \begin{itemize}
        \item \textbf{LO 1.1:} Phân biệt Dữ liệu (Data) và Thông tin (Information).
        \item \textbf{LO 1.2:} Hiểu cấu trúc của Hệ thống Thông tin Kế toán (AIS) và các chu trình kinh doanh.
        \item \textbf{LO 1.3:} Nắm bắt sự khác biệt giữa AI, Học máy (Machine Learning) và Học sâu (Deep Learning).
        \item \textbf{LO 1.4:} Sẵn sàng ứng dụng Generative AI (No-code) vào công việc kế toán hằng ngày.
    \end{itemize}
\end{frame}
...
with open(r"d:\DongAUniversity\TÀI LIỆU DẠY HỌC_2024-2025\Môn TTNT cho kế toán_2026\webAIAccounting\TaiLieu\slideAIAcc_v2\Slide_AIAcc_v2_Day01_LT.tex", "w", encoding="utf-8") as f:
    f.write(tex_content)
