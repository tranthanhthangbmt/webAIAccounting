...
en_content = ""
for i in range(1, 5):
    with open(os.path.join(dir_path, f'chunk7A_{i}.txt'), 'r', encoding='utf-8') as f:
        en_content += f.read() + "\n\n"

for i in range(1, 3):
    with open(os.path.join(dir_path, f'chunk7B_{i}.txt'), 'r', encoding='utf-8') as f:
        en_content += f.read() + "\n\n"

# Load Vietnamese chunks
vi_content = ""
for i in range(1, 5):
    with open(os.path.join(dir_path, f'chunk7A_{i}_vi.txt'), 'r', encoding='utf-8') as f:
        vi_content += f.read() + "\n\n"

for i in range(1, 3):
    with open(os.path.join(dir_path, f'chunk7B_{i}_vi.txt'), 'r', encoding='utf-8') as f:
        vi_content += f.read() + "\n\n"
...
<head>
    ...
    <title>Tài liệu Buổi 7 - AI Accounting</title>
...
<div class="container">
    <h1 style="text-align: center; color: #333;">Tài liệu Buổi 7: AI trong tài chính doanh nghiệp và kiểm toán</h1>
...
with open(os.path.join(dir_path, 'Buoi_07.html'), 'w', encoding='utf-8') as f:
    f.write(html_template)
print("Successfully created Buoi_07.html")
