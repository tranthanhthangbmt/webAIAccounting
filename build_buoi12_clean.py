# build_buoi12_clean.py
# Clean up and restructure docs/buoi_12.md to match the beautiful, professional formatting of Buoi 1 - Buoi 11

content = """# Buổi 12: Thực hành AI nhận thức và AI tạo sinh
...
with open('docs/buoi_12.md', 'w', encoding='utf-8') as f:
    f.write(content.strip() + '\n')

print("Successfully rebuilt docs/buoi_12.md with professional, stunning Markdown structure!")
