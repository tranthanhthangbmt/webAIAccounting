...
# Gather chunks
en_chunks = sorted(glob.glob(r"chunk12A_*.txt"))
...
<head>
    ...
    <title>Buổi 12 - AI Nhận thức và AI Tạo sinh trong Kế toán</title>
...
<body>
    ...
    <h1>Buổi 12: Thực hành AI nhận thức và AI tạo sinh</h1>
...
with codecs.open("Buoi_12.html", "w", "utf-8") as f:
    f.write(html_content)

print("Generated Buoi_12.html successfully.")
