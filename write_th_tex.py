...
% SLIDE 4
\begin{frame}{Mục tiêu phần Thực hành (Lesson Objectives)}
    \begin{itemize}
        \item Nắm được các công cụ phần mềm kế toán đang tích hợp AI mạnh mẽ nhất.
        \item Hiểu cách AI giải quyết bài toán thực tế qua các Case Study (từ Doanh nghiệp nhỏ đến Tập đoàn).
        \item Nắm bắt 5 bộ kỹ năng lõi của Kế toán viên kỷ nguyên AI.
        \item \textbf{Thực hành:} Giao tiếp cơ bản với ChatGPT qua Kỹ thuật Prompting.
    \end{itemize}
\end{frame}
...
with open(r"d:\DongAUniversity\TÀI LIỆU DẠY HỌC_2024-2025\Môn TTNT cho kế toán_2026\webAIAccounting\TaiLieu\slideAIAcc_v2\Slide_AIAcc_v2_Day01_TH.tex", "w", encoding="utf-8") as f:
    f.write(tex_content)
