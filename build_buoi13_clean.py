# build_buoi13_clean.py
# Restructure docs/buoi_13.md into a stunning, professional, and comprehensive Markdown document

content = """# Buổi 13: Kỹ thuật Prompt & Khởi động Phân tích dữ liệu (SPARKS)
...
<object data="pdfs/_OceanofPDF.com_ChatGPT_and_AI_for_Accountants_-_Scott_Dell_Mfon_Akpan.pdf" type="application/pdf" class="pdf-container">
    <p>Trình duyệt của bạn không hỗ trợ xem PDF nhúng. <a href="pdfs/_OceanofPDF.com_ChatGPT_and_AI_for_Accountants_-_Scott_Dell_Mfon_Akpan.pdf" target="_blank">Nhấn vào đây để tải tài liệu PDF</a>.</p>
</object>
...
with open('docs/buoi_13.md', 'w', encoding='utf-8') as f:
    f.write(content.strip() + '\n')

print("Successfully rebuilt docs/buoi_13.md into a stunning, professional Markdown document!")
