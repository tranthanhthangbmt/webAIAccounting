...
def create_beamer_day09():
    tex_content = r"""\documentclass[aspectratio=169, 12pt]{beamer}
...
"""
    ...
    with open("TaiLieu/slideAIAcc/Slide_AIAcc_Day09.tex", "w", encoding="utf-8") as f:
        f.write(tex_content)
    
    print("Generated TaiLieu/slideAIAcc/Slide_AIAcc_Day09.tex successfully.")
