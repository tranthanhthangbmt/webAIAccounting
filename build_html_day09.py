...
def build_html():
    # Gather chunks
    chunks_en = sorted(glob.glob(r"chunk9A_*.txt") + glob.glob(r"chunk9B_*.txt"))
...
<head>
    ...
    <title>Buổi 09 - Tài chính Cá nhân và Tài sản số</title>
    <style>
        body {{
...
<body>
    ...
    <h1>Buổi 09: AI trong tài chính cá nhân và tài sản số</h1>
...
"""
    ...
    with open("Buoi_09.html", "w", encoding="utf-8") as f:
        f.write(template)
        
    print("Buoi_09.html generated successfully!")
